...
function markPlatformAuthenticatorUnavailable() {
  $('label[for="attachmentPlatform"]').html(
    'On bound (platform) authenticator <span class="errorText">- Reported as not available</span>'
  );
}
...
function registerButtonClicked() {
  ...
  getChallenge()
    ...
    .then((credential) => {
      ...
      $("#status").text(
        "Successfully established TouchID login. Click the Authenticate button to verify that it's working."
      );
...
function authenticateButtonClicked() {
  ...
  getChallenge()
    ...
    .then((credential) => {
      $("#status").text("Successfully authenticated with TouchID");
...
function getChallenge() {
  return rest_get("/challenge").then((response) => {
    if (response.error) {
...
function createCredential(challenge) {
  ...
  var attachment = "platform"; //platform or cross-platform
...
function getAssertion(challenge) {
  ...
  var allowCredentialsSelection = "filled"; //filled or empty
